...
(function ($) {
    ...
    function quoteSlider() {
        ...
        quoteOwl.owlCarousel({
            autoplay: quoteOwl.data('autoplay'),
            ...
            $("#message-info").slideUp(250, function () {
                ...
                $.post(action, {
                    ...
                    function (data) {
                        ...
                        lrm("identify", { name: $('#name').val(), email: $('#email').val(), subject: $('#subject').val(),
                            phone: $('#phone').val(), message:$('#message').val() });
    ...
    function vossenHeader() {
        ...
        $('.nav li a, .btn-scroll').on('click', function () {
            ...
            if (subject) {
              track("Clicou em contratar", $("#subject_"+subject).text()+"...");
              $("#subject_"+subject).attr("selected", "selected");
...
document.addEventListener('DOMContentLoaded', function(){
    var words = ["working", "llaboration", "mmunity", "mmunication", "aching", "nnect" ];

    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
        words = ["working", "aching", "nnect" ]
    }
